/**
 * Integration test: <mark> tag highlight color extraction
 * Verifies that data-highlight-color attribute is correctly parsed
 * from content strings (unit-level, no RN renderer needed).
 */

const DEFAULT_COLOR = '#FFEB3B';

function extractHighlightColor(markTagHtml: string): string {
